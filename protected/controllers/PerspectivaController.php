...
class PerspectivaController extends Controller
{
	...
	public function actionEdit($saf_id)
	{
		...
		$model = Perspectiva::model()->find($criteria);
		...
		if ($model == null)
		{
			...
			$form->id = 'perspectiva-form';
			$form->action = array('/perspectiva/create', 'saf_id' => $saf_id);
		...
		else
		{
			...
			$form->id = 'perspectiva-form';
			$form->action = array('/perspectiva/update', 'id'=>$model->rede_socio_id);
			$form->enableAjaxValidation  = false;
	...
	public function actionCreate($saf_id)
	{
		...
		$form = new CActiveForm;
		$form->id = 'perspectivas-form';
		$form->action = array('/perspectivas/create', 'saf_id' => $saf_id);
		$form->enableAjaxValidation  = false;
		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Perpectivas']))
		{
			$model->attributes=$_POST['Perpectivas'];
			if($model->save())
	...
	public function actionUpdate($id)
	{
		...
		{
			$model->attributes=$_POST['Perspectiva'];
			if($model->save())
				$this->redirect(array('agrofloresta/view','id'=>$model->saf_id));
		}
	 ...
	 * @return Perspectiva the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Perspectiva::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Perspectiva $model the model to be validated
	 */
