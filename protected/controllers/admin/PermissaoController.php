...
class PermissaoController extends Controller
{
	...
	/*
	 * Verifica se a ação feita é permitida
	 * @param integer $idUsuario id do usuario logado
	 * @param string @acao ação executada pelo usuario
	 */
	public function VerificaAcao($idUsuario, $controller, $acao)
	{
