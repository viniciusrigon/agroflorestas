 ...
 * @property string $avaliacao_produtor
...
class Visita extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('saf_id, observacoes', 'required'),
			array('saf_id', 'numerical', 'integerOnly'=>true),
			array('avaliacao_produtor', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('visita_id, saf_id, avaliacao_produtor, observacoes', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'visita_id' => 'Visita',
			'saf_id' => 'Saf',
			'avaliacao_produtor' => 'O que representou nossa atividade aqui? Como foi para você nos receber?',
	...
	public function search()
	{
		...
		$criteria->compare('avaliacao_produtor',$this->avaliacao_produtor,true);
